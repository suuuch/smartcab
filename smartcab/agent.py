...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = self.a ** self.trial
            # self.epsilon = 1 / (self.trial ** 2)
            self.epsilon = math.e ** (-1 * self.a * self.trial)
        return None
    ...
    def build_state(self):
        ...
        state = (waypoint, inputs['light'], inputs['left'], inputs['oncoming'], inputs['right'],deadline)
...
def run(a, alpha=0.5, epsilon=1.0, tolerance=0.005):
    ...
    print(' ===== Args a=%s, alpha=%s, epsilon=%s, tolerance=%s' % (a, alpha, epsilon, tolerance))
    env = Environment()
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=epsilon, alpha=alpha, a=a / 10.0)
